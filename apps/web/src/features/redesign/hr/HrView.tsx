...
import { HrBand } from "./HrBand";
import { HrBottom } from "./HrBottom";
import { HrRightRail } from "./HrRightRail";
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="flex items-center gap-2 text-2xl font-semibold tracking-tight text-rd-heading">
              HR Command Center
              <UserCog className="h-5 w-5 text-rd-muted" aria-hidden />
            </h1>
            <p className="mt-0.5 text-sm text-rd-body">
              Real-time headcount, hiring, engagement, and people intelligence.
            </p>
          </div>
        </div>
